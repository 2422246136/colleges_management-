        ...
        <Modal v-model="showModal" title="修改信息" width='700px'>
            <Row class="formGroup">
                <Col span="12">
                    ...
                    <Col span="19" class="itemForm">
                        <Input placeholder="请输入姓名" maxlength="10" v-model="formItem.name" class="inputWidth inputBorder" disabled/>
                    </Col>
                </Col>
                <Col span="12">
                    <Col span="5" class="itemName">
            ...
            <Row class="formGroup">
                <Col span="12">
                    ...
                    <Col span="19" class="itemForm">
                        ...
                        <Select style="width:90%" v-model="formItem.gender" >
            ...
            <Row class="formGroup">
                <Col span="12">
                    ...
                    <Col span="19" class="itemForm">
                        <Input placeholder="请输入联系电话" maxlength="11" v-model="formItem.phone" class="inputWidth inputBorder"/>
                    </Col>
                </Col>
                 <Col span="12">
                    <Col span="5" class="itemName">
                       <span>*</span> <label>工号:</label>
                    </Col>
                    <Col span="19" class="itemForm">
                        <Input placeholder="请输入教师工号" maxlength="10" v-model="formItem.no" class="inputWidth inputBorder" disabled/>
                    </Col>
                </Col>
            ...
            <Row class="formGroup">
                 ...
                 <Col span="12">
                    ...
                    <Col span="19" class="itemForm">
                        <Input type="password"  placeholder="请输入密码" maxlength="20" password  v-model="formItem.password" class="inputWidth inputBorder"/>
                    </Col>
                </Col>
                 <Col span="12">
                    <Col span="5" class="itemName">
                        <span>*</span><label>所属系:</label>
                    </Col>
                    <Col span="19" class="itemForm">
...
export default {
    components:{Modal,Button,Input,Select,Message,Option},
    data(){
        return {
